	...
	<div align="center">
		...
		<table class="table1">
			...
			<tr>
				...
				<th></th>
				<th><input type="button" value="결제하기" onclick="location.href='product_complete.pd' ">
					<input type="button" class="order" value="장바구니" onclick="location.href='product_cart.pd'">
				</th>
			</tr>
		</table>
